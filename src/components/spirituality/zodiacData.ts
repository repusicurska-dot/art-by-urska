...
export const SIGNS: Sign[] = [
  ...
  },
  {
    ...
    profile: {
      sl: "Dvojčka nikoli nista samo eno. V njiju živi radovednost, ki preskakuje od misli do misli, od pogovora do pogovora, kot da bi en sam odgovor nikoli ne bil dovolj. Njihov element je zrak — lahek, hiter, povsod prisoten. Svet razumejo tako, da o njem govorijo naglas.\n\nNjihov dar je um, ki poveže stvari, ki se na prvi pogled ne zdijo povezane. Senca pa je razpršenost — tolikšna lakota po novem, da lahko izgubijo stik s tistim, kar so si že zgradili. Dvojčka se učijo, da globina ni nasprotje radovednosti, samo njena počasnejša sestra.\n\nV ljubezni Dvojčka potrebujeta nekoga, s komer se lahko pogovarjata o vsem — tudi o tistem, česar še sama ne razumeta. Njuna duša se prepozna v besedah, ne le v tišini. Kdor jih res sliši, dobi dostop do obeh strani, ki ju nosijo v sebi.",
  ...
  },
  {
    ...
    profile: {
      sl: "Ribi plavajo med dvema svetovoma — resničnim in tistim, ki ga čutijo, še preden ga lahko razložijo. Njihov element je voda, njihova meja med domišljijo in resničnostjo pa tanjša kot pri kateremkoli drugem znamenju. Razumejo s srcem, preden razumejo z umom.\n\nNjihov dar je sočutje, ki ne pozna meja — čutijo bolečino drugih, kot bi bila njihova lastna. Senca pa je izguba sebe v tem sočutju, dokler ne pozabijo, kje se konča drugi in začne oni sami. Ribi se učijo, da meje niso sebičnost. So preživetje.\n\nV ljubezni Ribi ljubijo brezpogojno, včasih bolj, kot je zanje samo dobro. Njihova duša prepozna drugo dušo na način, ki ga ne zna razložiti — samo ve. Kdor jim vrne enako nežnost, dobi ljubezen, ki se ne meri, ampak preprosto je.",
